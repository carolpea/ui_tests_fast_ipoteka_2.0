...
class IndexPage:
    @staticmethod
    def open_index_page(page: Page) -> None:
        page.goto(config.url.DOMAIN_TEST)

    @staticmethod
    def text_on_buttom(page: Page) -> None:
        return page.locator('.layout-navbar-footer__info__role').text_content()

    @staticmethod
    def auth_manager(page: Page) -> None:
    ...
    @staticmethod
    def auth_super_admin(page: Page) -> None:
        page.get_by_test_id("input-email").click()
